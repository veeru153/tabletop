...
const Widget = ({ id, z, type, q }) => {
    ...
    switch(type) {
        case w.Clock:
            return <Clock z={z} q={q} savedState={getSavedState(id)}/>
        case w.CovidLarge:
            return <CovidLarge z={z} q={q} savedState={getSavedState(id)}/>
        case w.CovidSmall:
            return <CovidSmall z={z} q={q} savedState={getSavedState(id)}/>
        case w.StickyNote:
            return <StickyNote z={z} savedState={getSavedState(id)}/>
        case w.WeatherSmall:
            return <WeatherSmall z={z} q={q} savedState={getSavedState(id)} />
        default:
            return (<div></div>)
    }
