...
const Tut3 = (props) => {
    ...
    return (
        ...
        >
            <h2 style={{ margin: '14px 0', fontSize: 23 }}>What else can I do?</h2>
            ...
            <p style={{ margin: '4px 0', fontSize: 15 }}>Download the app by clicking <a target="_blank" href="https://github.com/veeru153/tabletop/releases" style={styles.a}>here</a> to experience all the features.</p>
